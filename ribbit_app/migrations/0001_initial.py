...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ribbit_app_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gravatar_url', self.gf('django.db.models.fields.files.ImageField')(default='/static/gfx/default.jpg', max_length=100)),
    ...
    models = {
        ...
        u'ribbit_app.userprofile': {
            ...
            'gravatar_url': ('django.db.models.fields.files.ImageField', [], {'default': "'/static/gfx/default.jpg'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
